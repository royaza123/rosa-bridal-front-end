// Enhanced Customization Modal with Stripe Integration
// Update your existing customization-modal.js with this code
...
function openCustomizationModal(productName, price, imageSrc, productId) {
        ...
        <div>
          <form id="customization-form">
              ...
              <div style="display: grid; gap: 1rem;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                  <div>
                    ...
                    <input type="text" name="firstName" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  </div>
                  <div>
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Last Name</label>
                    <input type="text" name="lastName" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  </div>
                </div>
                <div>
                  <label style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Email</label>
                  <input type="email" name="email" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                </div>
                <div>
                  <label style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Phone</label>
                  <input type="tel" name="phone" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                </div>
              </div>
            </div>
              ...
              <div style="display: grid; gap: 1rem;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                  <div>
                    ...
                    <input type="date" name="weddingDate" style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  </div>
                  <div>
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Wedding Venue Style</label>
                    <select name="venueStyle" style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
              ...
              <div style="display: grid; gap: 1rem;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                  <div>
                    ...
                    <select name="style" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  ...
                  <div>
                    ...
                    <select name="neckline" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                  <div>
                    ...
                    <select name="color" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  ...
                  <div>
                    ...
                    <select name="fabric" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                  <div>
                    ...
                    <select name="train" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
                  ...
                  <div>
                    ...
                    <select name="size" required style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
            ...
            <div style="margin-bottom: 2rem;">
              ...
              <select name="budget" style="width: 100%; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 6px;">
  ...
  if (userData) {
    ...
    if (user.firstName) form.querySelector('[name="firstName"]').value = user.firstName;
    if (user.lastName) form.querySelector('[name="lastName"]').value = user.lastName;
    if (user.email) form.querySelector('[name="email"]').value = user.email;
    if (user.weddingDate) form.querySelector('[name="weddingDate"]').value = user.weddingDate;
  }
  ...
  modal.querySelector('.submit-customization').addEventListener('click', function() {
    ...
    const requiredFields = ['firstName', 'lastName', 'email', 'phone', 'style', 'neckline', 'color', 'fabric', 'train', 'size'];
    let isValid = true;
    ...
    const customizations = {
      ...
      wedding: {
        date: formData.get('weddingDate'),
        venueStyle: formData.get('venueStyle')
      },
      design: {
    ...
    if (typeof ml !== 'undefined') {
      ml('track', 'custom_design_request', {
        ...
        contact_email: customizations.contact.email,
        budget_range: customizations.design.budget,
        wedding_date: customizations.wedding.date,
...
CUSTOMER CONTACT:
Name: ${customizations.contact.firstName} ${customizations.contact.lastName}
Email: ${customizations.contact.email}
Phone: ${customizations.contact.phone}

WEDDING DETAILS:
Date: ${customizations.wedding.date || 'Not specified'}
Venue Style: ${customizations.wedding.venueStyle || 'Not specified'}
...
Style: ${customizations.design.style}
Neckline: ${customizations.design.neckline}
Color: ${customizations.design.color}
Fabric: ${customizations.design.fabric}
Train: ${customizations.design.train}
Size: ${customizations.design.size}
Budget Range: ${customizations.design.budget || 'Not specified'}
