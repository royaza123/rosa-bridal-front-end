// E-commerce functionality for Roza Bridal

// Site Base URL
const siteBaseUrl = document.querySelector('meta[name="baseurl"]')?.content || '';
...
class ShoppingCart {
  ...
  setupCartIcon() {
    ...
    // Create header controls container if it doesn't exist
...
// Initialize cart and auth on page load
